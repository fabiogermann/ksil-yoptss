...
if(logged_in())
{
	...
	if($site == 'custom_itm')
	{
		...
		if($action == 'next_custom_ing')
		{
            ...
            echo '<td><form method="post" action="touch.php?site=custom_itm&amp;action=custom_itm_cookie&amp;ingr='.$ingr.'&amount='.$sum_ingr.'"><button name="add_cust_ingr" action="submit"><img src="thumbs/good.gif" width="40" height="40" /></button></form></td>';
            echo '</tr>';
        }
        echo '</table>';
