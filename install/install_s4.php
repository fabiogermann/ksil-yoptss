...
<div id="content">
<div id="breadCrumb"> <span class="style3">/ Installation & Update / Step 4</span></div>
<br />
<h2 id="pageName">Installing Table Content</h2>

<?php
require("global.php");
echo '<br />opening connection . . . <img src="../thumbs/tick.png" width="30" /><br />';
require("insert_table.php");
?>
...
<!--end navbar -->
<div id="siteInfo"><div align="right"><button  onclick="javascript:window.open('install_s5.php', '_self')" value="next" ><h1>Next 5/8</h1></button></div></div>
<br />
